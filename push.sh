...
echo ""
echo -e "${YELLOW}${BOLD}  Langkah selanjutnya — SSH ke VPS, lalu jalankan:${NC}"
echo ""
echo -e "  ${CYAN}ssh root@IP_VPS${NC}"
echo -e "  ${CYAN}bash /var/www/sdms/update.sh${NC}"
echo ""
echo -e "  ${BOLD}Opsi lain:${NC}"
echo -e "  ${CYAN}bash /var/www/sdms/update.sh --skip-build${NC}  # Backend saja (cepat)"
echo -e "  ${CYAN}bash /var/www/sdms/update.sh --dry-run${NC}   # Preview perubahan"
echo -e "  ${CYAN}bash /var/www/sdms/update.sh --seed${NC}     # Update + seed data"
echo ""
